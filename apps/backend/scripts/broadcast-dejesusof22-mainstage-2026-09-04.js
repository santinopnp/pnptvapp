...
const LOG_TABLE   = 'broadcast_dejesusof22_mainstage_2026_09_04';
const DM_CHANNEL  = 'dejesusof22_mainstage_dm';
const TG_CHANNEL  = 'dejesusof22_mainstage_tg';
...
function dmText(lang) {
  if (isEs(lang)) {
    return `🔴 @Dejesusof22 · MAIN STAGE · EN VIVO

Él. En vivo. Sin filtros — como lo has estado imaginando.

O tómalo 1:1 — llamada privada desde $50 (30 min) · $100 (1 h).

🔴 Entrar a Main Stage 👉 ${MAIN_STAGE_URL}
❖ Su perfil 👉 ${BOOK_URL}`;
  }
  return `🔴 @Dejesusof22 · MAIN STAGE · NOW

Him. Live. Unfiltered — exactly the way you've been thinking about him.

Or take him 1:1 — private call from $50 (30 min) · $100 (1 h).
...
function tgCaption(lang) {
  if (isEs(lang)) {
    return (
      `🔴 <b>@Dejesusof22 · MAIN STAGE · EN VIVO</b>\n\n` +
      `Él. En vivo. Sin filtros — como lo has estado imaginando.\n\n` +
      `O tómalo <b>1:1 — llamada privada desde $50</b> (30 min) · $100 (1 h).\n\n` +
      `Elige 👇`
    );
  }
  return (
    `🔴 <b>@Dejesusof22 · MAIN STAGE · NOW</b>\n\n` +
    `Him. Live. Unfiltered — exactly the way you've been thinking about him.\n\n` +
    `Or take him <b>1:1 — private call from $50</b> (30 min) · $100 (1 h).\n\n` +
    `Pick your move 👇`
  );
}
...
const PUSH_COPY = {
  es: { title: '🔴 @Dejesusof22 · EN VIVO', body: 'Main Stage ahora · llamadas desde $50' },
  en: { title: '🔴 @Dejesusof22 · LIVE',    body: 'Main Stage now · calls from $50' },
};

const PUSH_COMMON = {
  url : MAIN_STAGE_URL,
  icon: '/icon-192.png',
  tag : 'dejesusof22-mainstage-2026-09-04',
};
