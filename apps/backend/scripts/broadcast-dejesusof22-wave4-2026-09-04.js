...
const LOG_TABLE   = 'broadcast_dejesusof22_wave4_2026_09_04';
const DM_CHANNEL  = 'dejesusof22_wave4_dm';
const TG_CHANNEL  = 'dejesusof22_wave4_tg';
...
function dmText(lang) {
  if (isEs(lang)) {
    return `🔴 @Dejesusof22 · TURNO TARDE

Está entrando más profundo. Esta es la mejor parte.

Reserva un 1:1 mientras puedas — $50 (30 min) · $100 (1 h).

🔴 Entrar a Main Stage 👉 ${MAIN_STAGE_URL}
❖ Reservar 1:1 👉 ${BOOK_URL}`;
  }
  return `🔴 @Dejesusof22 · LATE SHIFT

He's dropping deeper. This is the good part.

Book a 1:1 while you still can — $50 (30 min) · $100 (1 h).
...
function tgCaption(lang) {
  if (isEs(lang)) {
    return (
      `🔴 <b>@Dejesusof22 · TURNO TARDE</b>\n\n` +
      `Está entrando más profundo. Esta es la mejor parte.\n\n` +
      `<b>Reserva un 1:1 mientras puedas</b> — $50 (30 min) · $100 (1 h).\n\n` +
      `Ahora 👇`
    );
  }
  return (
    `🔴 <b>@Dejesusof22 · LATE SHIFT</b>\n\n` +
    `He's dropping deeper. This is the good part.\n\n` +
    `<b>Book a 1:1 while you still can</b> — $50 (30 min) · $100 (1 h).\n\n` +
    `Now 👇`
  );
}
...
const PUSH_COMMON = {
  url : MAIN_STAGE_URL,
  icon: '/icon-192.png',
  tag : 'dejesusof22-wave4-2026-09-04',
};
