const strings = {
  en: {
    ...
    currentTierTrial: "Your 3-day PRIME trial is active",
    upgradeCta: "Upgrade to unlock more features",
    extendCta: "Extend or upgrade your plan below",
    trialExpiresCta: "Keep your access — choose a plan before it expires",

    // ── Founders Membership offer ────────────────────────────────────────────
    foundersOfferTag: "🖤 Founders Membership",
    foundersOfferExpires: "Offer expires in",
    foundersOfferExpired: "Offer expired",
  ...
  es: {
    ...
    currentTierTrial: "Tu trial PRIME de 3 días está activo",
    upgradeCta: "Mejora tu plan para desbloquear más funciones",
    extendCta: "Extiende o mejora tu plan abajo",
    trialExpiresCta: "Mantén tu acceso — elige un plan antes de que expire",

    // ── Founders Membership offer ────────────────────────────────────────────
    foundersOfferTag: "🖤 Membresía Founders",
    foundersOfferExpires: "Oferta expira en",
    foundersOfferExpired: "Oferta expirada",
  ...
  pt: {
    ...
    currentTierTrial: "Seu trial PRIME de 3 dias está ativo",
    upgradeCta: "Atualize para desbloquear mais recursos",
    extendCta: "Estenda ou atualize seu plano abaixo",
    trialExpiresCta: "Mantenha seu acesso — escolha um plano antes que expire",
    foundersOfferTag: "🖤 Membership Founders",
    foundersOfferExpires: "Oferta expira em",
    foundersOfferExpired: "Oferta expirada",
  ...
  zh: {
    ...
    currentTierTrial: "您的3天PRIME试用版已激活",
    upgradeCta: "升级以解锁更多功能",
    extendCta: "在下方延长或升级您的方案",
    trialExpiresCta: "保持访问权限 — 在试用到期前选择方案",
    foundersOfferTag: "🖤 创始会员",
    foundersOfferExpires: "优惠到期",
    foundersOfferExpired: "优惠已过期",
  ...
  zhTW: {
    ...
    currentTierTrial: "您的3天PRIME試用版已啟用",
    upgradeCta: "升級以解鎖更多功能",
    extendCta: "在下方延長或升級您的方案",
    trialExpiresCta: "保持存取權限 — 在試用到期前選擇方案",
    foundersOfferTag: "🖤 創始會員",
    foundersOfferExpires: "優惠到期",
    foundersOfferExpired: "優惠已過期",
  ...
  fr: {
    ...
    currentTierTrial: "Votre essai PRIME de 3 jours est actif",
    upgradeCta: "Passez à un plan supérieur pour plus de fonctionnalités",
    extendCta: "Prolongez ou améliorez votre plan ci-dessous",
    trialExpiresCta: "Maintenez votre accès — choisissez un plan avant l'expiration",
    foundersOfferTag: "🖤 Membership Fondateurs",
    foundersOfferExpires: "L'offre expire dans",
    foundersOfferExpired: "Offre expirée",
  ...
  de: {
    ...
    currentTierTrial: "Deine 3-tägige PRIME-Testversion ist aktiv",
    upgradeCta: "Upgrade um mehr Funktionen freizuschalten",
    extendCta: "Verlängere oder verbessere deinen Plan unten",
    trialExpiresCta: "Behalte deinen Zugang — wähle einen Plan vor dem Ablauf",
    foundersOfferTag: "🖤 Gründer-Mitgliedschaft",
    foundersOfferExpires: "Angebot läuft ab in",
    foundersOfferExpired: "Angebot abgelaufen",
  ...
  it: {
    ...
    currentTierTrial: "La tua prova PRIME di 3 giorni è attiva",
    upgradeCta: "Passa a un piano superiore per sbloccare più funzionalità",
    extendCta: "Estendi o migliora il tuo piano qui sotto",
    trialExpiresCta: "Mantieni l'accesso — scegli un piano prima della scadenza",
    foundersOfferTag: "🖤 Membership Founders",
    foundersOfferExpires: "L'offerta scade tra",
    foundersOfferExpired: "Offerta scaduta",
  ...
  tr: {
    ...
    currentTierTrial: "3 günlük PRIME deneme süren aktif",
    upgradeCta: "Daha fazla özellik için yükselt",
    extendCta: "Planını aşağıdan uzat veya yükselt",
    trialExpiresCta: "Erişimini koru — süresi dolmadan bir plan seç",
    foundersOfferTag: "🖤 Kurucu Üyeliği",
    foundersOfferExpires: "Teklif sona eriyor",
    foundersOfferExpired: "Teklif sona erdi",
  ...
  ru: {
    ...
    currentTierTrial: "Ваша 3-дневная пробная версия PRIME активна",
    upgradeCta: "Обновите план, чтобы разблокировать больше функций",
    extendCta: "Продлите или обновите план ниже",
    trialExpiresCta: "Сохраните доступ — выберите план до истечения срока",
    foundersOfferTag: "🖤 Членство основателей",
    foundersOfferExpires: "Предложение истекает через",
    foundersOfferExpired: "Предложение истекло",
  ...
  nl: {
    ...
    currentTierTrial: "Je 3-daagse PRIME-proefperiode is actief",
    upgradeCta: "Upgrade om meer functies te ontgrendelen",
    extendCta: "Verleng of verbeter je plan hieronder",
    trialExpiresCta: "Behoud je toegang — kies een plan voor het verloopt",
    foundersOfferTag: "🖤 Founders Lidmaatschap",
    foundersOfferExpires: "Aanbieding verloopt over",
    foundersOfferExpired: "Aanbieding verlopen",
  ...
  vi: {
    ...
    currentTierTrial: "Bản dùng thử PRIME 3 ngày của bạn đang hoạt động",
    upgradeCta: "Nâng cấp để mở khóa thêm tính năng",
    extendCta: "Gia hạn hoặc nâng cấp gói bên dưới",
    trialExpiresCta: "Giữ quyền truy cập — chọn gói trước khi hết hạn",
    foundersOfferTag: "🖤 Thành viên Founders",
    foundersOfferExpires: "Ưu đãi hết hạn sau",
    foundersOfferExpired: "Ưu đãi đã hết hạn",
  ...
  ja: {
    ...
    currentTierTrial: "3日間のPRIMEトライアルが有効です",
    upgradeCta: "アップグレードしてさらに多くの機能を解放",
    extendCta: "以下でプランを延長またはアップグレード",
    trialExpiresCta: "アクセスを維持 — 期限前にプランを選択してください",
    foundersOfferTag: "🖤 Founders メンバーシップ",
    foundersOfferExpires: "オファー残り",
    foundersOfferExpired: "オファー終了",
  ...
  id: {
    ...
    currentTierTrial: "Uji coba PRIME 3 hari kamu aktif",
    upgradeCta: "Tingkatkan untuk membuka lebih banyak fitur",
    extendCta: "Perpanjang atau tingkatkan paketmu di bawah",
    trialExpiresCta: "Pertahankan akses — pilih paket sebelum kedaluwarsa",
    foundersOfferTag: "🖤 Keanggotaan Founders",
    foundersOfferExpires: "Penawaran berakhir dalam",
    foundersOfferExpired: "Penawaran berakhir",
  ...
  ar: {
    ...
    currentTierTrial: "تجربتك المجانية PRIME لمدة 3 أيام نشطة",
    upgradeCta: "قم بالترقية لإتاحة المزيد من الميزات",
    extendCta: "قم بتمديد خطتك أو ترقيتها أدناه",
    trialExpiresCta: "حافظ على وصولك — اختر خطة قبل انتهاء الصلاحية",
    foundersOfferTag: "🖤 عضوية Founders",
    foundersOfferExpires: "العرض ينتهي خلال",
    foundersOfferExpired: "انتهى العرض",
