const strings = {
  en: {
    ...
    tokenActPayOnMeru: (usd: number) => `Pay $${usd.toFixed(2)} on Meru`,
    tokenActIAlreadyPaid: "I already paid — Activate now",
    tokenActCopyCode: "Copy code",
    ...
    tokenActEmailPlaceholder: "you@example.com",
    tokenActEmailHint: "We'll send the activation code to this address.",
    tokenActEmailInvalid: "Enter a valid email address",
    tokenActPrivacyNote: "Your activation code is saved locally. If you close this window, re-open it from the link in your email.",
  },
  ...
  es: {
    ...
    tokenActPayOnMeru: (usd: number) => `Pagar $${usd.toFixed(2)} en Meru`,
    tokenActIAlreadyPaid: "Ya pagué — Activar ahora",
    tokenActCopyCode: "Copiar código",
    ...
    tokenActEmailPlaceholder: "ejemplo@correo.com",
    tokenActEmailHint: "Te enviaremos el código de activación a este correo.",
    tokenActEmailInvalid: "Ingresa un correo electrónico válido",
    tokenActPrivacyNote: "Tu código se guarda localmente. Si cierras esta ventana, ábrela de nuevo desde el enlace en tu correo.",
  },
} as const;
