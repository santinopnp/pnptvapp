const strings = {
  en: {
    ...
    groupDescriptionPlaceholder: "Shown to members inside the hangout...",
    groupDescriptionLabel: "Group description",
    aboutTitle: "About this Hangout",
    aboutRules: "Rules",
    aboutVibes: "Vibes",
  ...
  es: {
    ...
    groupDescriptionPlaceholder: "Se mostrará a los miembros dentro del hangout...",
    groupDescriptionLabel: "Descripción del grupo",
    aboutTitle: "Acerca de este Hangout",
    aboutRules: "Reglas",
    aboutVibes: "Vibras",
