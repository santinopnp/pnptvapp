...
const T = {
  ...
  s5Row3: { en: "Your tokens appear in your account",     es: "Tus tokens aparecen en tu cuenta" },
  s5RewardLine: {
    en: "🎁 You got 30 free tokens to spend with Santino for completing the tutorial.",
    es: "🎁 Ganaste 30 tokens gratis para usar con Santino por completar el tutorial.",
  },
  s5FooterNote: {
...
const BUY_CLIPS: Record<WalletKey, Clip[]> = {
  ...
  trust: [
    ...
    { src: TW_SRC, start: 115.5, end: 120,
      ...
      desc:  { en: "This is the screen where your balance will show. While the payment is processing tokens still show 0.00. Once the provider releases the purchase (minutes with card), the amount appears here and you can pay in PNPtv.",
               es: "Esta es la pantalla donde aparecerá tu saldo: mientras el pago se procesa los tokens siguen en 0,00. Cuando el proveedor libera la compra (minutos con tarjeta), el monto aparece aquí y ya puedes pagar en PnP." },
...
const PAY_CLIPS: Record<WalletKey, Clip[]> = {
  metamask: [
    { src: TW_SRC, start: 118, end: 127,
      ...
      caption: { en: "PNPtv checkout: tokens + MetaMask / Trust Wallet icons", es: "Checkout de PnP: tokens + iconos MetaMask / True Wallet" } },
