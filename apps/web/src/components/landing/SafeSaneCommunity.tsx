  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ background: "linear-gradient(90deg, transparent, rgba(212,0,122,0.5), rgba(123,97,255,0.5), transparent)" }}
      />

      {/* ── LG+ full-bleed horizontal split ── */}
      <div className="hidden lg:flex w-full">
        {/* Left 40%: bold statement in ethnocentric face */}
        <div
          className="w-[40%] flex-shrink-0 flex flex-col items-start justify-center px-10 xl:px-16 py-14"
          style={{ borderRight: "1px solid rgba(212,0,122,0.12)" }}
        >
          {/* Shield icon */}
          <div
          ...
          <h2
            ...
            className="text-4xl xl:text-5xl font-bold text-white leading-tight whitespace-pre-line"
          ...
          {/* 18+ badge */}
          <div
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-xs font-bold mt-8"
            style={{
        ...
        {/* Right 60%: harm-reduction copy + legal link chips */}
        <div className="flex-1 flex flex-col justify-center px-10 xl:px-16 py-14 gap-6">
          <div className="space-y-4 text-sm text-pnp-textSecondary leading-relaxed max-w-xl">
            <p>{c.body1}</p>
            <p>{c.body2}</p>
          </div>

          {/* Legal links as chips/pills */}
            ...
            <div className="flex flex-wrap items-center gap-2">
              {c.links.map((link) => (
                <a
                  key={link.href}
                  href={link.href}
                  className="px-3 py-1.5 rounded-full text-xs font-semibold transition-colors duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-pnp-accent rounded-full"
                  style={{
                  ...
                  onMouseLeave={(e) => {
                    (e.currentTarget as HTMLAnchorElement).style.color = "#A1A1A3";
      ...
      <div className="lg:hidden px-4 py-14 sm:px-6">
        <div className="max-w-3xl mx-auto text-center space-y-5">
          ...
          <h2
            id="safe-community-heading-mobile"
      ...
      <div
        aria-hidden="true"
        className="w-full h-[1px]"
        style={{ background: "linear-gradient(90deg, transparent, rgba(123,97,255,0.5), rgba(212,0,122,0.5), transparent)" }}
      />
    </section>
  );
}
