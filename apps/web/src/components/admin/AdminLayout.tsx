...
const CREATOR_RESTRICTED_PATHS = new Set([
  ...
  // HangoutModeration has a destructive "End Hangout" action — restrict to
  // super-admins only so creator-admins cannot terminate any hangout.
  "/admin/hangouts",
]);
...
const allNavItems: NavItem[] = [
  ...
  { to: "/admin/hangouts", labelKey: "hangouts", icon: "M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z", creatorAllowed: false },
  ...
  { to: "/admin/growth-sales", labelKey: "growthSales", icon: "M13 7h8m0 0v8m0-8l-8 8-4-4-6 6", creatorAllowed: false },
  ...
  { to: "/admin/customer-research", label: "Radiografía de clientes", icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z", creatorAllowed: false },
  { to: "/admin/traffic-report", label: "Reporte de tráfico", icon: "M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z", creatorAllowed: false },
  ...
  { to: "/admin/manual-activations", label: "Manual Activations", icon: "M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z", creatorAllowed: false },
  ...
  { to: "/admin/calls", label: "Book a Call", icon: "M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z", creatorAllowed: true },
  { to: "/admin/call-diagnostics", label: "Call Diagnostics", icon: "M9 12l2 2 4-4M12 2a10 10 0 100 20 10 10 0 000-20z", creatorAllowed: false },
