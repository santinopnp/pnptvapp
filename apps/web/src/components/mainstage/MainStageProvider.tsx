...
export function MainStageProvider({ children }: { children: React.ReactNode }) {
  ...
  const isOnMainStage = miniPathname.startsWith("/main-stage") || miniPathname === "/subscribe" || miniPathname === "/lifetime100" || miniPathname === "/nequinegocios" || miniPathname === "/mercadopago" || /^\/dm\/[^/]+/.test(miniPathname);
