...
const UPDATE_MESSAGES: RawMessage[] = [
  ...
  {
    category: "UPDATE",
    en: "⚡ Subscribe to a creator right from their live drawer — no redirect, instant →",
    es: "⚡ Suscríbete a un creador directo desde el drawer en vivo — sin redirigir, al instante →",
    href: "/main-stage",
  },
  {
    category: "UPDATE",
    en: "💎 Your PNPtv Wallet is live — top up, tip creators, pay for calls and content →",
    es: "💎 Tu Billetera PNPtv está lista — recarga, tipea a creadores, paga llamadas y contenido →",
    href: "/wallet",
  },
  {
    category: "UPDATE",
  ...
  {
    category: "UPDATE",
    en: "🍎 Apple Pay & Google Pay available — top up your Ru$h wallet in seconds →",
    es: "🍎 Apple Pay y Google Pay disponibles — recarga tu wallet Ru$h en segundos →",
    href: "/wallet",
  },
  {
    category: "UPDATE",
    en: "🚢 Cruise Mode & 📍 Share Location live under Settings → Preferences →",
    es: "🚢 Cruise Mode y 📍 Compartir ubicación en Ajustes → Preferencias →",
    href: "/settings/preferences",
  },
  {
    category: "UPDATE",
    en: "Save with crypto — pay for your plan with USDC, BTC, USDT & more →",
    es: "Ahorra con cripto — paga tu plan con USDC, BTC, USDT y más →",
    href: "/subscribe",
  },
  {
    category: "UPDATE",
...
const TIP_MESSAGES: RawMessage[] = [
  ...
  { category: "TIP", en: "PRIME videos load faster than ever. Open one now.", es: "Los videos PRIME cargan más rápido que nunca. Abre uno ya.", href: "/channels" },
...
export function AnnouncementStrip() {
  ...
  if (location.pathname === "/main-stage" || location.pathname === "/subscribe" || location.pathname === "/lifetime100" || location.pathname === "/nequinegocios" || location.pathname === "/mercadopago") return null;
