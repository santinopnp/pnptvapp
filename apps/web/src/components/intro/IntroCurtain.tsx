    ...
    >
      ...
      >
        <div
          style={{
            ...
            fontWeight: 600,
            // Long channel names would either wrap awkwardly or push the
            // canvas layout tiny; clamp to a single line with ellipsis.
            maxWidth: isPortrait ? 720 : 1000,
            whiteSpace: 'nowrap',
            overflow: 'hidden',
      ...
      >
        ...
        >
          ...
          >
            {clauses.map((c) => (
              <div key={c.n} style={{ display: 'flex', gap: 16 }}>
                <div
                  style={{
                    fontFamily: FONT_DISPLAY,
                    color: COLORS.magenta,
