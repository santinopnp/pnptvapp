        ...
        {step === 4 && (
          <div className="rounded-[14px] p-[18px]" style={{ background: "#161616", border: "1px solid #2A2A2A" }}>
            ...
            <p className="text-[11px] font-bold text-pnp-textSecondary mt-3.5 mb-1.5">
              Al publicar, se genera un preview promocional que se comparte automáticamente en:
            </p>
            <div className="flex flex-col gap-1">
              <span className="text-[11px] text-white/80">✓ Main Stage chat</span>
              <span className="text-[11px] text-white/80">✓ Feed oficial de PNPtv</span>
              <span className="text-[11px] text-white/80">✓ Tu hangout personal</span>
            </div>
            <TipCallout>
              Sube previews de tus videos en el canal gratuito para atraer suscriptores al canal de pago.
            </TipCallout>
          </div>
        )}
